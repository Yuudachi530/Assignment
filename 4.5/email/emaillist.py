...
server = poplib.POP3_SSL('pop.163.com') # 使用pop3服务器
server.user('ygjzcycdr@163.com') # 用户名
server.pass_('OSQELCNRFLYRNAZF') # 授权码

resp, mails, octects = server.list() # 获取邮件列表
